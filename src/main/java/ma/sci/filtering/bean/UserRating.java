...
public class UserRating implements Serializable {
    ...
    public int getLemonsRating() {
        return lemonsRating;
    }

    public void setLemonsRating(int lemonsRating) {
        this.lemonsRating = lemonsRating;
    }
    ...
    public String toString() {
        return "ma.sci.filtering.bean.UserRating[ id=" + id + " ]";
    }
